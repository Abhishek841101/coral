...
export default function BookingSuccess() {
  ...
  if (!bookingId) {
    return (
      <main className="min-h-screen bg-[#F8F9F7] flex items-center justify-center px-5">
        <div className="w-full max-w-lg rounded-3xl bg-white p-8 text-center shadow-sm border border-gray-100">
  ...
  return (
    <main className="min-h-screen bg-[#F8F9F7] px-4 py-10 sm:px-6 lg:px-8">
